...
# Build Ubuntu 18.04 LTS "Bionic Beaver"
echo "### Building Ubuntu 18.04 base..."
docker build --no-cache --pull -t movesrwth/storm-basesystem:ubuntu-18.04 --build-arg LINUX_BASE=ubuntu:18.04 .
docker push movesrwth/storm-basesystem:ubuntu-18.04
echo "### Building Ubuntu 18.04 base finished."
